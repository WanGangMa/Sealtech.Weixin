...
using Sealtech.Weixin.Domain;
using System.Linq.Expressions;
using System.Collections;
using System.Threading.Tasks;
using Sealtech.Weixin.CodeLib;
...
namespace Sealtech.Weixin.Core
{
    ...
    public abstract class RepositoryBase<T> : IRepository<T> where T : class
    {
        ...
        public virtual PageInfo Query(int index, int pageSize, string tableName, string field, string filter, string orderby, string group, params DbParameter[] para)
        {
            ...
            if (list != null)
                return new PageInfo(index, pageSize, count, list);
        ...
        public virtual PageInfo Query(IQueryable query, int index, int PageSize)
        {
            ...
            return new PageInfo(index, PageSize, count, JsonConverter.JsonClass(enumerable.ToList()));
        }
        #endregion
